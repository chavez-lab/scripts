...
# sbatch AmpliconClassifierMImod.sh [params passed to amplicon_classifier.py]
...
python /expanse/lustre/projects/csd677/collab/bin/AmpliconClassifier/amplicon_classifier.py $@
